...
.fa-google {
  ...
  color: white;
			...
			<header><!--header starts-->
				...
				<div id="logo">
				<h1>TRUENEWS<span id="iisrt"> </span><div class="search-container">
         ...
         <!-- Social Media Icons Start -->
                        <li style="float: right;"><a  ref="#" class="fa fa-facebook"></a></li>
                        <li style="float: right;"><a ref="#" class="fa fa-twitter"></a></li>
                        <li style="float: right;"><a ref="#" class="fa fa-google"></a></li>
...
!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='https://weatherwidget.io/js/widget.min.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','weatherwidget-io-js');
			...
			<div class="leftcolumn">
                ...
                <div class="ourserv" >
					...
					<?php //this is for search engine. 
           global $con;
              if (isset($_GET['search'])) 
               {
                    $user_keyword = $_GET['user_query'];
                    $get_post = "select * from posts where search_keywords like '%$user_keyword%'"; //this is for searched products
                    $run_post = mysqli_query($con,$get_post);
                    while ($row_post = mysqli_fetch_array($run_post))
                    {
